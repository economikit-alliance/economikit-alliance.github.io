...
<radialGradient id="radialGradient1"
  ...
  <stop class="stopG1_2" offset="100%"/>
      ...
      function getPathInstructions(xS, yS, xE, yE, setIdx, pointsIdx) {
        return `M 0,0
    C 0,0
    ${rPointsArray[setIdx][pointsIdx] - xS},${rPointsArray[setIdx][pointsIdx + 1] - xY}
    ${rPointsArray[setIdx][pointsIdx + 2] - xS},${rPointsArray[setIdx][pointsIdx + 3] - xY}
    S ${rPointsArray[setIdx][pointsIdx + 4] - xS},${rPointsArray[setIdx][pointsIdx + 5] - xY}
    ${xE - xS},${yE - xY}`
      }
...
//# sourceMappingURL=ek-logo-c167d1b6.js.map
