  ...
  <stop class="stopG1_2" offset="100%"/>
    ...
    ${xE},${yE}`
      ...
      function applyPathAnim(cycleDuration, transitionDuration, path, ani, anim, xS, yS, xE, yE, setIdx, pointsIdx) {
        ...
        const animStartPath = getPathInstructions(xO, yO, xS, yS, xE, yE, setIdx, pointsIdx);
        ...
        .transition()
        .duration(transitionDuration)
        .attr('path', getPathInstructions(xO, yO, xS, yS, xE, yE, setIdx + 1, pointsIdx));
      }
...
//# sourceMappingURL=ek-logo-a7ea0509.js.map
