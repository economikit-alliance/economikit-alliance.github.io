...
<radialGradient id="radialGradient1"
  ...
  <stop class="stopG1_2" offset="100%"/>
    ...
    ${xE},${yE}`
      ...
      function applyPathAnim(cycleDuration, path, ani, anim, xS, yS, xE, yE, setIdx, pointsIdx) {
        const path1 = getPathInstructions(xS, yS, xE, yE, setIdx, pointsIdx);
        const path1N = getPathInstructions(xS, yS, xE, yE, setIdx + 1, pointsIdx);
      ...
      window.randomizeEKLogo = function(
        ...
        applyPathAnim(cycleDuration, path1, ani1, anim1, x1, y1, x2, y2, cT, 0);
        applyPathAnim(cycleDuration, path2, ani2, anim2, x2, y2, x1, y1, cT, 6);

        cT = cT + 1;
        if (cT == 29){cT = 1;}
        ani1.setAttribute('dur', cycleDuration + 'ms');
        ani1.setAttribute('path', path1Instructions);
        anim1
        ...
        ani2.setAttribute('path', path2Instructions);
        anim2
...
//# sourceMappingURL=ek-logo-eee0df53.js.map
