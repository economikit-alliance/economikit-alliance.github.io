System.register([], function (exports) {
  ...
  return {
    execute: function () {
      ...
      const bboxWidth = 255 * 3,  // :IMPORTANT: must match `svg.ek-text` attributes in HTML
            bboxHeight = 180 * 3;
      const pV =[50, 90, 140];
...
<radialGradient id="radialGradient1"
  ...
  <stop class="stopG1_2" offset="100%"/>
      ...
      ir.setAttribute('x', x2);
      ir.setAttribute('y', y2);
      ...
      function getPathInstructions(xS, yS, xE, yE, setIdx, pointsIdx) {
        return `M 0,0
    C 0,0
    ${rPointsArray[setIdx][pointsIdx] - xS},${rPointsArray[setIdx][pointsIdx + 1] - yS}
    ${rPointsArray[setIdx][pointsIdx + 2] - xS},${rPointsArray[setIdx][pointsIdx + 3] - yS}
    S ${rPointsArray[setIdx][pointsIdx + 4] - xS},${rPointsArray[setIdx][pointsIdx + 5] - yS}
    ${xE - xS},${yE - yS}`
      }
...
//# sourceMappingURL=ek-logo-7f5c317c.js.map
