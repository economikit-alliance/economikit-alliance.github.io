...
<radialGradient id="radialGradient1"
  ...
  <stop class="stopG1_2" offset="100%"/>
    ...
    ${xE},${yE}`
      ...
      function applyPathAnim(path, xS, yS, xE, yE, setIdx, pointsIdx) {
      ...
      window.randomizeEKLogo = function(
        ...
        applyPathAnim(path1, x1, y1, x2, y2, cT, 0);
        applyPathAnim(path2, x2, y2, x1, y1, cT, 6);
...
//# sourceMappingURL=ek-logo-1ed5cf8c.js.map
