  ...
  <stop class="stopG1_2" offset="100%"/>
    ...
    ${xE},${yE}`
      ...
      window.randomizeEKLogo = function(
        ...
        applyPathAnim(cycleDuration, transitionDuration, path1, ani1, anim1, x1, y1, x2, y2, cT, 0);
        applyPathAnim(cycleDuration, transitionDuration, path2, ani2, anim2, x2, y2, x1, y1, cT, 6);
...
//# sourceMappingURL=ek-logo-d3cf27f0.js.map
