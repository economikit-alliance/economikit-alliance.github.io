  ...
  <stop class="stopG1_2" offset="100%"/>
    ...
    ${xE - xO},${yE - yO}`
      ...
      function applyPathAnim(cycleDuration, transitionDuration, path, ani, anim, xS, yS, xE, yE, setIdx, pointsIdx) {
        ...
        const animStartPath = getPathInstructions(0, 0, xS, yS, xE, yE, setIdx, pointsIdx);
        ...
        .transition()
        .duration(transitionDuration)
        .attr('path', getPathInstructions(0, 0, xS, yS, xE, yE, setIdx + 1, pointsIdx));
      }
...
//# sourceMappingURL=ek-logo-67adb634.js.map
